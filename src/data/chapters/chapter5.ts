    ...
    choices: [
      {
        ...
        feedback: '熊孩子一把抢过手机就开始下载游戏。本马全程盯着他的每一个动作，心跳比坐过山车还快。🫠',
      },
      {
        id: 'ch5_kid_refuse',
        text: '不给！上次你摔了我手机',
        ...
        nextNodeId: 'ch5_blind_date',
        feedback: '熊孩子当场哇哇大哭，表姐投来了"你怎么跟小孩计较"的眼神。本马虽然守住了手机，但社会性死亡了。😅',
      },
      {
        id: 'ch5_kid_oldphone',
        text: '掏出一个老年机：玩这个',
        ...
        nextNodeId: 'ch5_blind_date',
        feedback: '熊孩子接过老年机，一脸懵逼地研究贪吃蛇怎么玩。本马露出了胜利的微笑——姜还是老马辣。📱',
      },
    ],
  },
