...
const chapter4Nodes: Record<string, StoryNode> = {
  ...
  ch4_ufo_home: {
    ...
    chapter: 4,
    narrative: [
      '飞碟消失在夜空中，留下一圈淡淡的光晕，比任何烟花都好看。',
      '全村人还在仰头看天，你爸已经一把拽住你的胳膊往家走。',
      '你妈跟在后面，嘴里念叨着："回来就好，回来就好……坐什么回来的不重要……"',
      '隔壁张婶追上来问："那个外星人还来不来？我想让他帮我看看风水！"',
      '🐴 突然有点想哭。不管用什么方式回来，家还是那个家。',
      '推开家门，一桌子菜的香味扑面而来。',
      '到家了！！！',
      '但是……亲戚们也到了。',
      '……战斗才刚刚开始。',
